...
BROWSER_SOURCES := $(BROWSER_SRC_DIR)/main.m \
                   ...
                   $(BROWSER_SRC_DIR)/Privacy/BrowserLocationPreferences.m \
                   ...
                   $(BROWSER_SRC_DIR)/Navigation/BrowserNavigationTimeouts.m \
                   ...
                   $(BROWSER_SRC_DIR)/PagePack/PagePackModels.m \
                   $(BROWSER_SRC_DIR)/PagePack/PagePackMatcher.m \
                   $(BROWSER_SRC_DIR)/PagePack/PagePackStore.m \
                   ...
                   $(BROWSER_SRC_DIR)/TabOverview/BrowserTabThumbnailCache.m \
                   $(BROWSER_SRC_DIR)/TabOverview/BrowserTabOverviewCardView.m \
                   ...
                   $(BROWSER_SRC_DIR)/LoginAssist/Companion/PhoneChatModels.m \
                   $(BROWSER_SRC_DIR)/LoginAssist/Companion/PhoneChatStore.m \
                   $(BROWSER_SRC_DIR)/LoginAssist/Companion/PhoneChatWindowController.m \
                   $(BROWSER_SRC_DIR)/LoginAssist/Companion/PhoneAppIconCache.m \
                   ...
                   $(BROWSER_SRC_DIR)/SyncCore/SyncKind.m \
