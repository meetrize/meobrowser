...
```json
{
  ...
  "deviceToken": "long-token",
  "requestId": "uuid",
  "code": "disabled|a11y_required|contact_not_found|background_launch_blocked|paste_failed|send_failed|wechat_not_installed|busy|timeout|invalid",
  "message": "人可读说明"
}
```
...
| `background_launch_blocked` | 系统拦截后台打开微信（常见于小米未开「后台弹出界面」） |
