...
| **地图叠加校准** | P3 | Google Maps 卫星图与路网/POI 手动对齐（种子 Page Pack + 页内 HUD）；见 [maps-overlay-calibration-design.md](maps-overlay-calibration-design.md) · [maps-overlay-calibration-development-plan.md](maps-overlay-calibration-development-plan.md) |
