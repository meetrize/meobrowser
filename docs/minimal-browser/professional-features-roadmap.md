...
| **多窗口** | 新窗口打开链接、窗口级会话恢复（方案：[multi-window-design.md](multi-window-design.md)，计划：[multi-window-development-plan.md](multi-window-development-plan.md)） |
...
| **地图叠加校准** | P3 | **两个种子 Pack**：Maps `maps-overlay-calibration` · Earth `earth-overlay-calibration`；见 [design](maps-overlay-calibration-design.md) · [Earth](maps-overlay-calibration-earth-design.md) |
...
| **页面爬虫（可视化抽取）** | P2 | 侧栏点选 DOM、表格/单一数据、翻页、配方；导出 Excel/CSV/JSON 与 MySQL；定时用独立 helper。见 [page-scraper-design.md](page-scraper-design.md) · [page-scraper-development-plan.md](page-scraper-development-plan.md) |
...
- [ ] 自签名证书开发模式（CERT-0/1 会话例外 + 警告页 + 地址栏已落地，见 insecure-https-design.md；CERT-2 开发模式开关未做）
- [ ] 可选 User CSS/JS
